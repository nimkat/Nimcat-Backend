    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'A user with that mobile number already exists.'}, max_length=50, null=True, unique=True, validators=[common.util.mobileValidator.UnicodeMobileNumberValidator()], verbose_name='Mobile Number')),
